...
public sealed class LocalizedDrawPageTests : IDisposable
{
    private readonly TempCardLibrary _library = TempCardLibrary.Create("cardpicker-localized-draw-tests-");
    private readonly WebApplicationFactory<Program> _factory;

    public LocalizedDrawPageTests()
    {
    ...
    [Fact]
    public async Task Home_WithEnglishCookieAndResultCardId_RendersSameCardIdentityInEnglish()
    {
        ...
        Assert.DoesNotContain("Savory Rice Porridge", html);
    }
