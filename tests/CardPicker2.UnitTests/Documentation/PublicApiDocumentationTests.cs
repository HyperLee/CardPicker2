...
public sealed class PublicApiDocumentationTests
{
    ...
    [InlineData("CardPicker2/Models/CardPreferenceState.cs")]
    [InlineData("CardPicker2/Models/CardPreferenceCriteria.cs")]
    [InlineData("CardPicker2/Models/CardPreferenceUpdateInputModel.cs")]
    [InlineData("CardPicker2/Models/PreferenceMutationResult.cs")]
    ...
    [InlineData("CardPicker2/Models/CardPreferenceState.cs")]
    [InlineData("CardPicker2/Models/FavoriteFilter.cs")]
    [InlineData("CardPicker2/Models/DrawEligibilityFilter.cs")]
    [InlineData("CardPicker2/Models/CardPreferenceCriteria.cs")]
    [InlineData("CardPicker2/Models/CardPreferenceUpdateInputModel.cs")]
    [InlineData("CardPicker2/Models/PreferenceMutationResult.cs")]
    [InlineData("CardPicker2/Models/FilterSummary.cs")]
    [InlineData("CardPicker2/Models/RotationCooldownSettings.cs")]
    [InlineData("CardPicker2/Models/RotationSnapshot.cs")]
    [InlineData("CardPicker2/Models/RotationCandidatePool.cs")]
    [InlineData("CardPicker2/Models/CandidatePoolEmptyReason.cs")]
    [InlineData("CardPicker2/Models/MealCardInputModel.cs")]
    ...
    [InlineData("CardPicker2/Services/DrawRotationCooldownService.cs")]
