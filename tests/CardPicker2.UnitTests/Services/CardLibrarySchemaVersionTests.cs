...
{
    [Fact]
    public async Task LoadAsync_WhenLegacySchemaV1IsValid_MigratesInMemoryToSchemaV3()
    {
    ...
    [Fact]
    public async Task LoadAsync_WhenBilingualSchemaV2IsValid_MigratesInMemoryToSchemaV3()
    {
        using var library = TempCardLibrary.Create();
    ...
    [Fact]
    public async Task LoadAsync_WhenJsonIsMissing_CreatesSchemaV3SeedWithEmptyHistory()
    {
        using var library = TempCardLibrary.Create();
        var service = CreateService(library.FilePath);
