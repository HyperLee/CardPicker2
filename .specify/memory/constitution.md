...
Modified Principles: all principles created from markdownFolder/tempConstitution.md
Added Sections: 核心原則, 技術標準, 開發工作流程, 治理規則
Removed Sections: none
Templates requiring updates:
- ✅ .specify/templates/plan-template.md - aligned with constitution gates
- ✅ .specify/templates/spec-template.md - aligned with zh-TW and measurable requirements
- ✅ .specify/templates/tasks-template.md - aligned with TDD and quality gates
- ✅ .specify/templates/checklist-template.md - localized and aligned with evidence checks
- ✅ docs/readme-template.md - aligned with zh-TW documentation requirement
...
所有使用者面向畫面與訊息 MUST 使用一致的設計語言、Bootstrap 5 元件、
`site.css` 自訂樣式與繁體中文。畫面 MUST 在桌面與行動尺寸下保持可操作、
...
所有使用者面向文件 MUST 使用繁體中文 zh-TW，包括功能規格、實作計畫、
研究文件、資料模型、快速入門指南、任務清單、README 與使用者可見錯誤訊息。
