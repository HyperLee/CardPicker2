...
public static class SeedMealCards
{
    ...
    public static IReadOnlyList<MealCard> All { get; } = new[]
    {
        Create(
            ...
            CompleteMetadata(
                ...
                new[] { DietaryPreference.TakeoutFriendly },
                SpiceLevel.None)),
        Create(
        ...
        Create(
            ...
            CompleteMetadata(
                ...
                PriceRange.Medium,
                PreparationTimeRange.Quick,
                new[] { DietaryPreference.TakeoutFriendly, DietaryPreference.HeavyFlavor },
                SpiceLevel.None)),
        Create(
        ...
        Create(
            ...
            CompleteMetadata(
                new[] { "鍋物", "暖胃" },
                PriceRange.High,
                PreparationTimeRange.Long,
                new[] { DietaryPreference.HeavyFlavor },
                SpiceLevel.None)),
        Create(
        ...
        Create(
            ...
            PartialMetadata(
                ...
                PriceRange.Medium,
                PreparationTimeRange.Standard,
                new[] { DietaryPreference.Vegetarian, DietaryPreference.Light },
                SpiceLevel.Mild)),
        Create(
        ...
        MealCardDecisionMetadata? decisionMetadata = null)
    {
        ...
        {
            DecisionMetadata = decisionMetadata?.Normalize()
        };
    }

    private static MealCardDecisionMetadata CompleteMetadata(
    ...
    private static MealCardDecisionMetadata PartialMetadata(
        IReadOnlyList<string> tags,
        PriceRange? priceRange,
        PreparationTimeRange? preparationTimeRange,
        IReadOnlyList<DietaryPreference> dietaryPreferences,
